...
function rtb_print_form_text_field( $slug, $title, $value, $args = array(),$placeholder) {
	...
	<div <?php echo rtb_print_element_class( $slug, $classes ); ?>>
		...
		<input placeholder="<?php echo $placeholder; ?>" type="<?php echo $type; ?>" name="rtb-<?php echo $slug; ?>" id="rtb-<?php echo $slug; ?>" value="<?php echo $value; ?>"<?php echo $required; ?>>
	</div>
...
function rtb_print_form_textarea_field( $slug, $title, $value, $args = array(),$placeholder) {
	...
	<div <?php echo rtb_print_element_class( $slug, $classes ); ?>>
		...
		<textarea placeholder="<?php echo $placeholder; ?>" name="rtb-<?php echo $slug; ?>" id="rtb-<?php echo $slug; ?>"<?php echo $required; ?>><?php echo $value; ?></textarea>
	</div>
...
function rtb_print_form_select_field( $slug, $title, $value, $args ) {
	...
	<div <?php echo rtb_print_element_class( $slug, $classes ); ?>>
		...
		<select class="guest-select" name="rtb-<?php echo $slug; ?>" id="rtb-<?php echo $slug; ?>"<?php echo $required; ?>>
		<option value="Guests" disbaled selected>Guests</option>
