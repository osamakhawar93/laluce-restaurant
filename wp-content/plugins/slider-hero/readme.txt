...
Tags: slider, video background, text carousel, banner slider, video slider, responsive header image slider, best slider plugin, responsive slider, hero banner, hero slider, hero image slider, animated background, animated banner slider, background animation, Parallax, Ken Burns
...
== Description ==
Slider Hero is a futuristic, responsive header Hero Slider plugin and <strong>Dyanmic Website Intro Advert</strong> maker with Youtube Video background and animated background effects for hero banners, hero sliders and Landing pages. Create awesome animation slider and animated header with text carousel and Call to Action buttons. Use youtube video background or combine animation effect and youtube video. 

Slider Hero includes a Shortcode Generator Slider Block for Gutenberg.
